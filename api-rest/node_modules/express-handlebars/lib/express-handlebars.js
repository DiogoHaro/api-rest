...
function ExpressHandlebars(config) {
    ...
    utils.assign(this, {
        ...
        extname        : '.handlebars',
        layoutsDir     : './src/resources/mail/auth/', // Default layouts directory is relative to `express settings.view` + `layouts/`
        partialsDir    : './src/resources/mail/auth/', // Default partials directory is relative to `express settings.view` + `partials/`
